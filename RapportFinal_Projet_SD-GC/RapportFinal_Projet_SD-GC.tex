...
\begin{document}
	...
	\begin{enumerate}
		...
		%\includegraphics[width=0.7\textwidth]{images/Matrice_d-incidence.extension}\\         1)
		...
		%\includegraphics[width=0.7\textwidth]{images/Tableau_sommets-successeurs.extension}\\         2)
		...
		%\includegraphics[width=0.7\textwidth]{images/Tableau_de_listes_de_successeurs.extension}\\         3)
	...
	De manière schématique, sur un exemple, les structures de données ressembleraient donc à :
	\begin{itemize}
		...
		%\includegraphics[width=0.7\textwidth]{images/}\\         5)
